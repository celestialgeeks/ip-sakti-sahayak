    ...
    <main className="flex-1 relative flex flex-col items-center h-full">
      ...
      <div className="relative z-10 w-full max-w-[860px] mx-auto px-4 sm:px-6 pt-6 pb-4 flex flex-col items-center flex-1">
        ...
        <div className="flex flex-col items-center text-center w-full mb-6">
          ...
          <p className="text-[14px] sm:text-[16px] text-slate-600 max-w-[700px] leading-relaxed font-sans">
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-3 mb-4">
          {/* Query Card 1 */}
          <button 
            className="text-left p-3.5 rounded-xl bg-white border border-slate-200 hover:border-[#195280] hover:shadow-md transition-all duration-150 group flex flex-col justify-between cursor-pointer" 
          ...
          >
            ...
            <span className="text-[11px] text-slate-500 mt-2 pt-2 border-t border-slate-100 flex items-center gap-1.5">
